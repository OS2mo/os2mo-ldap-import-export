        ...
        "CONVERSION_MAPPING": json.dumps(
            {
                "ldap_to_mo": {
                    ...
                    "PublicEmailAddress": {
                        ...
                        "uuid": "{{ get_address_uuid({'address_type': {'user_keys': ['EmailEmployee']}, 'employee': {'uuids': [employee_uuid]}}) or uuid4() }}",
                        "value": "{{ ldap.mail or '' }}",
        ...
        "CONVERSION_MAPPING": json.dumps(
            {
                "ldap_to_mo": {
                    ...
                    "EntryUUID": {
                        ...
                        "uuid": "{{ get_ituser_uuid({'itsystem': {'user_keys': ['ADUUID']}, 'employee': {'uuids': [employee_uuid]}}) or uuid4() }}",
