...
@pytest.mark.usefixtures("test_client", "role_facet")
async def test_to_mo(
    ...
    await trigger_ldap_sync(group_uuid)
    assert await get_class(str(group_uuid)) is None
