        ...
        "CONVERSION_MAPPING": json.dumps(
            {
                "ldap_to_mo": {
                    ...
                    "ADtitle": {
                        ...
                        "uuid": "{{ get_ituser_uuid({'itsystem': {'user_keys': ['ADtitle']}, 'employee': {'uuids': [employee_uuid]}}) }}",
                        "user_key": "{{ ldap.title }}",
...
async def test_to_mo(
    ...
    async for attempt in retrying():
        with attempt:
            assert await get_it_user() is None
