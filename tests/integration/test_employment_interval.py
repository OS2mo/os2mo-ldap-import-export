    ...
    await graphql_client.engagement_create(
        input=EngagementCreateInput(
            ...
            validity=RAValidityInput(
                from_="2020-01-01T00:00:00Z", to="2020-12-31T00:00:00Z"
            ),
        )
    )
    await graphql_client.engagement_create(
        input=EngagementCreateInput(
            ...
            primary=primary,
            validity=RAValidityInput(
                from_="2021-01-01T00:00:00Z", to="2021-12-31T00:00:00Z"
            ),
        )
    )
    await graphql_client.engagement_create(
        input=EngagementCreateInput(
            ...
            primary=primary,
            validity=RAValidityInput(
                from_="2019-01-01T00:00:00Z", to="2022-12-31T00:00:00Z"
            ),
        )
    )
