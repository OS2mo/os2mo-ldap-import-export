        ...
        "CONVERSION_MAPPING": json.dumps(
            {
                "ldap_to_mo": {
                    ...
                    "Engagement": {
                        ...
                        "engagement_type": "{{ load_mo_primary_engagement({'employee': {'uuids': [employee_uuid]}, 'from_date': None, 'to_date': None}).engagement_type }}",
                        "job_function": "{{ load_mo_primary_engagement({'employee': {'uuids': [employee_uuid]}, 'from_date': None, 'to_date': None}).job_function }}",
                        "primary": "{{ load_mo_primary_engagement({'employee': {'uuids': [employee_uuid]}, 'from_date': None, 'to_date': None}).primary }}",
...
async def test_to_mo(
    ...
    async def get_engagement() -> dict[str, Any] | None:
    ...
    async for attempt in retrying():
        with attempt:
            assert await get_engagement() is None
        ...
        "CONVERSION_MAPPING": json.dumps(
            {
                "ldap_to_mo": {
                    ...
                    "Engagement": {
                        ...
                        "uuid": "{{ skip_if_none(load_mo_primary_engagement({'employee': {'uuids': [employee_uuid]}, 'from_date': None, 'to_date': None})).uuid }}",
                        "user_key": "{{ skip_if_none(load_mo_primary_engagement({'employee': {'uuids': [employee_uuid]}, 'from_date': None, 'to_date': None})).user_key }}",
                        "org_unit": "{{ skip_if_none(load_mo_primary_engagement({'employee': {'uuids': [employee_uuid]}, 'from_date': None, 'to_date': None})).org_unit }}",
                        "person": "{{ skip_if_none(load_mo_primary_engagement({'employee': {'uuids': [employee_uuid]}, 'from_date': None, 'to_date': None})).person }}",
                        "job_function": "{{ skip_if_none(load_mo_primary_engagement({'employee': {'uuids': [employee_uuid]}, 'from_date': None, 'to_date': None})).job_function }}",
                        "engagement_type": "{{ skip_if_none(load_mo_primary_engagement({'employee': {'uuids': [employee_uuid]}, 'from_date': None, 'to_date': None})).engagement_type }}",
                        "primary": "{{ skip_if_none(load_mo_primary_engagement({'employee': {'uuids': [employee_uuid]}, 'from_date': None, 'to_date': None})).primary }}",
                        "extension_1": "{{ ldap.title }}",
                    },
                },
                # TODO: why is this required?
    ...
    await graphql_client.engagement_create(
        input=EngagementCreateInput(
            ...
            validity=RAValidityInput(
                from_="3000-01-01T00:00:00Z",
                to="4000-01-01T00:00:00Z",
            ),
        )
    )
