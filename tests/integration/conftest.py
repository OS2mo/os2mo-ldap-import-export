...
@pytest.fixture
async def leave_type_facet(graphql_client: GraphQLClient) -> UUID:
    return await _create_facet(graphql_client, "leave_type")


@pytest.fixture
async def visibility_facet(graphql_client: GraphQLClient) -> UUID:
...
@pytest.fixture
async def primary_type_facet(graphql_client: GraphQLClient) -> UUID:
...
@pytest.fixture
async def aduuid(graphql_client: GraphQLClient) -> UUID:
...
AddEngagement: TypeAlias = Callable[[str], Awaitable[UUID]]
...
async def add_engagement(
    ...
    async def adder(user_key: str) -> UUID:
