    ...
    await graphql_client.engagement_create(
        input=EngagementCreateInput(
            ...
            validity=RAValidityInput(
                from_="2001-02-03T04:05:06Z", to="2002-03-04T05:06:07Z"
            ),
        )
    )
...
async def test_load_primary_engagement_multiple_primaries(
    ...
    await graphql_client.engagement_create(
        input=EngagementCreateInput(
            ...
            primary=primary,
            fraction=100,
            validity=RAValidityInput(from_="2000-02-03T04:05:06Z"),
        )
    )
    await graphql_client.engagement_create(
        input=EngagementCreateInput(
...
async def test_load_primary_engagement_prefers_current(
    ...
    await graphql_client.engagement_create(
        input=EngagementCreateInput(
            ...
            fraction=100,
            validity=RAValidityInput(
                from_="1970-01-01T00:00:00Z", to="2000-01-01T00:00:00Z"
            ),
        )
    )
    await graphql_client.engagement_create(
        input=EngagementCreateInput(
            ...
            fraction=20,
            validity=RAValidityInput(
                from_="2000-01-01T00:00:00Z", to="3000-01-01T00:00:00Z"
            ),
        )
    )
    await graphql_client.engagement_create(
        input=EngagementCreateInput(
            ...
            fraction=50,
            validity=RAValidityInput(
                from_="3000-01-01T00:00:00Z", to="4000-01-01T00:00:00Z"
            ),
        )
    )
...
async def test_load_primary_engagement_prefers_less_futuristic(
    ...
    await graphql_client.engagement_create(
        input=EngagementCreateInput(
            ...
            fraction=100,
            validity=RAValidityInput(
                from_="3500-01-01T00:00:00Z", to="4000-01-01T00:00:00Z"
            ),
        )
    )
...
async def test_load_primary_engagement_prefers_future_validity(
    ...
    engagement1 = await graphql_client.engagement_create(
        input=EngagementCreateInput(
            ...
            primary=primary,
            fraction=20,
            validity=RAValidityInput(from_="2000-01-01T00:00:00Z", to=None),
        )
    )
    ...
    await graphql_client.engagement_update(
        input=EngagementUpdateInput(
            ...
            validity=RAValidityInput(from_="3000-01-01T00:00:00Z", to=None),
    ...
    await graphql_client.engagement_update(
        input=EngagementUpdateInput(
            ...
            engagement_type=ansat,  # This makes the new validity valid
            validity=RAValidityInput(from_="4000-01-01T00:00:00Z", to=None),
            # These are unchanged from the create above
            user_key="engagement2",
            person=mo_person,
            org_unit=mo_org_unit,
...
async def test_load_primary_engagement_prefers_now_over_past(
    ...
    await graphql_client.engagement_create(
        input=EngagementCreateInput(
            ...
            primary=primary,
            fraction=None,
            validity=RAValidityInput(from_="1970-01-01T00:00:00Z", to=None),
        )
    )
...
async def test_load_primary_engagement_ending_today(
    ...
    # NOTE: MO truncates validities to their date and interprets them in
    # Europe/Copenhagen, so tomorrow MUST be calculated in MO's timezone. Using
    # `datetime.now(tz=UTC) + timedelta(days=1)` makes the engagement start
    # *today* between midnight and 01:00/02:00, where the UTC date is still the
    # same as MO's date.
    await graphql_client.engagement_update(
        input=EngagementUpdateInput(
            ...
            fraction=100,
            validity=RAValidityInput(
                from_=mo_today() + timedelta(days=1),
                to=None,
            ),
        )
    )
